 ...
 */
class Studioraz_Faq_Helper_Jumplist extends Mage_Core_Helper_Abstract implements Countable, Iterator
{
	...
	public function __construct()
	{
		...
		{
			$chr = chr($ord);
			$this->items[$chr] = new Studioraz_Faq_Helper_JumplistItem($chr);
		}
		
		// TODO make configurable if KEY_OTHER is appended or prepended
		$this->items[self::KEY_OTHER] = new Studioraz_Faq_Helper_JumplistItem(self::KEY_OTHER);
	}
	
	public function setFaqItems(Studioraz_Faq_Model_Mysql4_Faq_Collection $items)
	{
