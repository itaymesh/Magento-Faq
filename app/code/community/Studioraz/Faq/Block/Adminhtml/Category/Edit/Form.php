 ...
 */
class Studioraz_Faq_Block_Adminhtml_Category_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    /**
     * Preperation of current form
     *
     * @return Studioraz_Faq_Block_Adminhtml_Category_Edit_Form
     */
