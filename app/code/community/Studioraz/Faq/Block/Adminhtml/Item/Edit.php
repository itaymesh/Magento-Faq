 ...
 */
class Studioraz_Faq_Block_Adminhtml_Item_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
	/**
	...
	public function __construct()
	{
		...
		$this->_updateButton('save', 'label', Mage::helper('studioraz_faq')->__('Save FAQ item'));
		$this->_updateButton('delete', 'label', Mage::helper('studioraz_faq')->__('Delete FAQ item'));
	...
	public function getHeaderText()
	{
		if (Mage::registry('faq')->getFaqId()) {
			return Mage::helper('studioraz_faq')->__("Edit FAQ item '%s'", $this->htmlEscape(Mage::registry('faq')->getQuestion()));
		}
		else {
			return Mage::helper('studioraz_faq')->__('New FAQ item');
		}
	}
