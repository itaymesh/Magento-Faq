 ...
 */
class Studioraz_Faq_Block_Adminhtml_Item_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * Constructor of Grid
     *
     ...
     *
     * @return Studioraz_Faq_Block_Admin_Grid Self
     */
    protected function _prepareCollection()
    {
        //TODO: add full name logic
        $collection = Mage::getResourceModel('studioraz_faq/faq_collection');
    ...
    protected function _prepareColumns()
    {
        $this->addColumn('faq_id', array (
                'header' => Mage::helper('studioraz_faq')->__('FAQ #'),
                'width' => '80px', 
                'type' => 'text', 
                'index' => 'faq_id' ));
        ...
        $this->addColumn('question', array (
                'header' => Mage::helper('studioraz_faq')->__('Question'),
                'index' => 'question' ));
        
        $this->addColumn('is_active', 
                array (
                        'header' => Mage::helper('studioraz_faq')->__('Active'),
                        'index' => 'is_active', 
                        'type' => 'options', 
                        'width' => '70px', 
                        'options' => array (
                                0 => Mage::helper('studioraz_faq')->__('No'),
                                1 => Mage::helper('studioraz_faq')->__('Yes') ) ));
        
        $this->addColumn('action', 
                array (
                        'header' => Mage::helper('studioraz_faq')->__('Action'),
                        'width' => '50px', 
                        'type' => 'action', 
                        'getter' => 'getId', 
                        'actions' => array (
                                array (
                                        'caption' => Mage::helper('studioraz_faq')->__('Edit'),
                                        'url' => array (
     ...
     *
     * @param Studioraz_Faq_Model_Faq $row Current rows dataset
