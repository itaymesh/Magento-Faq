 ...
 */
class Studioraz_Faq_Block_Frontend_Detail extends Mage_Core_Block_Template {
	 ...
	 *
	 * @return Studioraz_Faq_Model_Faq The current faq item
	 */
	public function getFaq() {
		if (!$this->_faq) {
			$id = intval($this->getRequest()->getParam('faq'));
			try {
				$this->_faq = Mage :: getModel('studioraz_faq/faq')->load($id);
