 ...
 */
class Studioraz_Faq_Block_Adminhtml_Item extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    /**
    ...
    public function __construct()
    {
        ...
        $this->_headerText = Mage::helper('studioraz_faq')->__('Manage FAQ Items');
        $this->_addButtonLabel = Mage::helper('studioraz_faq')->__('Add New FAQ Item');
