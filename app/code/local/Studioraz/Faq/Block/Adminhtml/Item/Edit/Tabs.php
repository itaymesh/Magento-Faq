 ...
 */
class Studioraz_Faq_Block_Adminhtml_Item_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    /**
    ...
    public function __construct()
    {
        ...
        $this->setTitle(Mage::helper('studioraz_faq')->__('FAQ item information'));
    }
    ...
    protected function _prepareLayout()
    {
        ...
        $this->addTab(
            ...
            array(
                ...
                'content' => $this->getLayout()->createBlock('studioraz_faq/adminhtml_item_edit_tab_main')->toHtml(),
                'active' => true,
            )
        );
