 ...
 */
class Studioraz_Faq_Block_Adminhtml_Category_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * Constructor of Grid
     *
    ...
    {
        $collection = Mage::getResourceModel('studioraz_faq/category_collection');
    ...
    protected function _prepareColumns()
    {
        $this->addColumn('category_id', array (
                'header' => Mage::helper('studioraz_faq')->__('Category #'),
                'width' => '80px', 
                'type' => 'text', 
                'index' => 'category_id' ));
        ...
        $this->addColumn(
            'category_name',
            array(
                'header' => Mage::helper('studioraz_faq')->__('Category Name'),
                'index' => 'category_name',
            )
        );
