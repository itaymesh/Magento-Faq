 ...
 */
class Studioraz_Faq_Model_Mysql4_Category extends Mage_Core_Model_Mysql4_Abstract
{
    /**
     * Constructor
     */
    ...
    {
        $this->_init('studioraz_faq/category', 'category_id');
    }
    ...
    protected function _getLoadSelect($field, $value, $object)
    {
        ...
        if ($object->getStoreId()) {
            $select->join(
                array('nns' => $this->getTable('studioraz_faq/category_store')),
     ...
     * @return Studioraz_Faq_Model_Mysql4_Category
     */
    ...
    protected function _afterSave(Mage_Core_Model_Abstract $object)
    {
        ...
        $this->_getWriteAdapter()->delete($this->getTable('studioraz_faq/category_store'), $condition);
        ...
        foreach ((array) $object->getData('stores') as $store) {
            ...
            $this->_getWriteAdapter()->insert(
                $this->getTable('studioraz_faq/category_store'), $storeArray
            );
        }
    ...
    protected function _afterLoad(Mage_Core_Model_Abstract $object)
    {
        $select = $this->_getReadAdapter()->select()->from(
            $this->getTable('studioraz_faq/category_store')
